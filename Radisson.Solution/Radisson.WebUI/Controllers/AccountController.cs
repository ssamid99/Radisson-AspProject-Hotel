...
namespace Radisson.WebUI.Controllers
{
    ...
    {
        private readonly SignInManager<RadissonUser> signInManager;
        private readonly UserManager<RadissonUser> userManager;
        private readonly EmailService emailService;

        public AccountController(SignInManager<RadissonUser> signInManager, UserManager<RadissonUser> userManager, EmailService emailService)
        {
